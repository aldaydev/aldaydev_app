...
import uux_capture_fullScreen from "../assets/images/projects/uux_capture_1200px.webp"
import uux_capture_desktop from "../assets/images/projects/uux_capture_400px.webp";
...
const projectsData = [
  {
    ...
    name: "Universal UX",
    description:
      "Desarrollo, maqueto, testeo, documento y publico componentes reutilizables para Universal UX, na librería de componentes reutilizables para las verisones más modernas de Angular, aprovechando funcionalidades como signals o zoneless.",
    date: "2025-09",
    rate: 6,
    language: "typescript",
    documentation: true,
    ...
    img: {
      fullScreen: uux_capture_fullScreen,
      desktop: uux_capture_desktop,
  ...
  },
  {
    ...
    name: "Alday.es",
    description:
      "Nueva versión de mi web musical donde puedes ver todos mis lanzamientos así como filtrar mis videoclips.",
    date: "2025-08",
    rate: 3,
    language: "typescript",
    documentation: false,
  ...
  },
  {
    ...
    name: "Cuadrapp",
    description:
      "Cuadrapp es una aplicación para gestión de presupuestosy gastos. En ella puedes crear un cuenta y gestionar tus finanzas de manera sencilla y práctica.",
    date: "2025-07",
    rate: 6,
    language: "typescript",
    documentation: false,
  ...
  },
  {
    ...
    name: "Mlink App",
    description:
      "Mlink es una app full stack tipo 'link tree' pensada para músicos. En ella puedes crear tu perfil, tener tu 'username' único y un enlace para compartir de una sola vez todas tus redes sociales como artista musical.",
    date: "2025-06",
    rate: 5,
    language: "typescript",
    documentation: true,
  ...
  },
  {
    ...
    description:
      "Este portfolio en el que estás ahora mismo. Aquí pretendo mostrarte de manera visual todos mis conocimientos y habilidades sobre desarrollow web. Podrás ver mis proyectos filtrándolos por tecnología, ver mi currículum y saber un poco más acerca de mí.",
    date: "2025-05",
    rate: 5,
    language: "javascript",
    documentation: false,
  ...
  },
  {
    ...
    name: "Chords API",
    description:
      "API Rest pública y gratuita. Pensada para desarrolladores que están empezando a hacer sus primeras peticiones (fetch, axios) y que, además, les gusta la música. Totalmente desplegada, vistas servidas desde el backend, documentación en inglés con Swagger y JSDoc.",
    date: "2025-04",
    rate: 4,
    language: "javascript",
    documentation: true,
  ...
  },
  {
    ...
    name: "Musikos App",
    description:
      "Versión beta de 'Musikos', una aplicación full stack creada para conectar músicos entre sí. En ella puedes buscarlos, filtrar por estilo, instrumento, ubicación, edad y nombre. También puedes crear tu cuenta para que otros músicos afines te encuentren.",
    date: "2025-03",
    rate: 4,
    language: "javascript",
    documentation: true,
  ...
  },
  {
    ...
    description:
      "Aplicación creada con React que consiste en un juego de pokemon donde puedes registrarte y ganar pokeballs al cazar pokemons y cumplir hitos. Creada con React, utilizando FireBase Auth para gestionar la autenticación y FireStore para la base de datos.",
    date: "2025-01",
    rate: 2,
    language: "javascript",
    documentation: false,
  ...
  },
  {
    ...
    description:
      "Mi website como artista musical. Realizado con HTML, CSS y JavaScript y creado en el contexto de mis estudios oficiales de 'Desarrollo de aplicaciones Web'.",
    date: "2024-11",
    rate: 1,
    language: "javascript",
    documentation: false,
  ...
  },
  {
    ...
    name: "CV Audiovisual",
    description:
      "Website con mi currículum audiovisual. Realizado con HTML, CSS y JavaScript y creado en el contexto del 'Master en CSS Avanzado'.",
    date: "2024-10",
    rate: 1,
    language: "javascript",
    documentation: false,
  ...
  },
  {
    ...
    description:
      "Proyecto de maquetación de la web de una agencia de desarollo web. Realizado con HTML, CSS y JavaScript y creado en el contexto del 'Master en CSS Avanzado'.",
    date: "2024-09",
    rate: 1,
    language: "javascript",
    documentation: false,
  ...
  },
  {
    ...
    description:
      "Proyecto de maquetación de un portal web de noticias de videojuegos. Realizado con HTML, CSS y JavaScript y creado en el contexto del 'Master en CSS Avanzado'.",
    date: "2024-08",
    rate: 1,
    language: "javascript",
    documentation: false,
