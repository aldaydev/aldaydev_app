            ...
            <div className='about__contentContainer'>
                ...
                <section className='about__flexSection'>
                    <article className='about__section'>
                        ...
                        <p className='about__sectionText'>Desde entonces y durante más de 12 años he aprendido a desenvolverme en el mundo laboral y a conseguir que el cliente siempre estuviera contento con el trato y el servicio que le ofrecía. Parecerá una tontería, pero siento que esta trayectoria me ha hecho formar parte de alguna manera de la ciudad de Madrid:</p>
